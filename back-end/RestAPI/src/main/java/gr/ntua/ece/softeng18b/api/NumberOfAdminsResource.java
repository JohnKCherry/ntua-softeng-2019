...
public class NumberOfAdminsResource extends ServerResource {
    ...
    protected Representation get() throws ResourceException {
    	...
    	if(!admin) {     
    	 ...
    	 Optional<Value> optional = dataAccess.getNumberOfAdmins();
    	 Value value = optional.orElseThrow(() -> new ResourceException(Status.CLIENT_ERROR_NOT_FOUND, "error of Number of admins"));
