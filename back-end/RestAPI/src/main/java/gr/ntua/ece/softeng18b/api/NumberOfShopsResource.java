...
public class NumberOfShopsResource extends ServerResource {
    ...
    protected Representation get() throws ResourceException {
    	...
    	if(!admin) {     
    	 ...
    	 Optional<Value> optional = dataAccess.getNumberOfShops();
    	 Value value = optional.orElseThrow(() -> new ResourceException(Status.CLIENT_ERROR_NOT_FOUND, "error of number of shops"));
