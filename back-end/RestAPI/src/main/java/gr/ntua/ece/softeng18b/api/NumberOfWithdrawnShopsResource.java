...
public class NumberOfWithdrawnShopsResource extends ServerResource {
    ...
    protected Representation get() throws ResourceException {
    	...
    	if(!admin) {     
    	 ...
    	 Optional<Value> optional = dataAccess.getNumberOfWithdrawnShops();
         Value value = optional.orElseThrow(() -> new ResourceException(Status.CLIENT_ERROR_NOT_FOUND, "error of number of withdrawn shops"));
