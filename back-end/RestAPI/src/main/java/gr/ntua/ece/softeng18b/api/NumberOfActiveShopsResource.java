...
public class NumberOfActiveShopsResource extends ServerResource {
    ...
    protected Representation get() throws ResourceException {
    	...
    	if(!admin) {     
    	 ...
    	 Optional<Value> optional = dataAccess.getNumberOfActiveShops();
         Value value = optional.orElseThrow(() -> new ResourceException(Status.CLIENT_ERROR_NOT_FOUND, "error of number of active shops"));
