...
public class NumberOfUsersResource extends ServerResource {
    ...
    protected Representation get() throws ResourceException {
    	...
    	if(!admin) {     
    	 ...
    	 Optional<Value> optional = dataAccess.getNumberOfUsers();
         Value value = optional.orElseThrow(() -> new ResourceException(Status.CLIENT_ERROR_NOT_FOUND, "error of number of users"));
